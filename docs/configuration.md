...
| Variable                           | Default                                          | Read by                             | Audience          | Notes                                                                                                                                                                                                                                                                                                                     |
| ---------------------------------- | ------------------------------------------------ | ----------------------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `SYMPHONY_MAX_NONPRODUCTIVE_TURNS` | `3`                                              | Orchestrator, worker, Codex runtime | User-facing/ops   | Maximum consecutive turns without local workspace/HEAD progress before convergence handling. At the threshold, a confirmed canonical state outside the workflow's active states completes the run; active/unconfirmed reads fail closed. Comments, PR pushes, and active-to-active transitions do not reset this counter. |
