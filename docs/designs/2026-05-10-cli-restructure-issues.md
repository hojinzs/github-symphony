...
> **Source spec:** `docs/designs/2026-05-10-cli-restructure-design.md` (commit `4e5acfc`)
> **Repository:** `hojinzs/github-symphony`
> **Status:** Completed — the restructure shipped via the 2026-05-10 commit series (see Status in the source spec). Historical planning artifact.
...
## Design slice (from `docs/designs/2026-05-10-cli-restructure-design.md`)
...
Full design: `docs/designs/2026-05-10-cli-restructure-design.md`
```
...
- Modify: `packages/control-plane/README.md:278` — references `gh-symphony start` and `gh-symphony project start`; update.
- Modify: `docs/reports/2026-05-04-single-repo-orchestrator-feasibility.md:25` — references `gh-symphony start`; update or annotate as historical.
