...
| Errors      | Empty or multi-operation documents, invalid GraphQL syntax, missing active-issue scope, missing host authentication, HTTP failures, and GraphQL errors are returned to the runtime as structured tool failures. Unknown tool names are rejected.                                                                                                                                                                                                                                                                                       |
...
Use one named operation and bind the active issue ID as an exact variable value.
