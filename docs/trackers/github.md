...
| Errors      | Invalid tool arguments, missing active-issue scope, missing host authentication, HTTP failures, and GraphQL errors are returned to the runtime as structured tool failures. Unknown tool names are rejected.                                                                                                                                                                                                                                                                                                   |
...
Use a named operation and pass the active issue ID or provider-native Project
item ID as an exact variable value. Keep mutations narrow—for example, update the active issue's
