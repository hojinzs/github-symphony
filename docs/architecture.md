...
only to worker-host Git subprocesses. Successful worker runs fetch, verify
fast-forward ancestry, and push the checked-out assigned branch before reporting
success.
