...
| Layer         | Spec mandate                                                                                                                                                                                                                                                             |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Policy        | **Implementation-defined** — the repo-defined `WORKFLOW.md` prompt and team-specific ticket handling, validation, and handoff rules are the Policy Layer (§3.2); selected policy still **MUST** be documented where the spec leaves a choice (Normative Language; §10.5) |
