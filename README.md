...
Project start also holds a lock keyed by the canonical project-folder path in a
stable host-wide namespace independent of caller temporary-directory and user
settings. Consequently, pointing separate `--config` runtime roots at the same
