...
| Controlled Codex startup failures                                            | `test/e2e/claude/claude-docker.spec.ts` starts the built worker through the Codex route without `PROJECT_ID` or `CODEX_PROJECT_ID`, then asserts its final failed heartbeat and exit code `1`. CI runs this focused built-worker regression with `pnpm test:worker-startup` after building the workspace.                                                                                                                                                                                                                                                                                                                                                    | `pnpm e2e:claude` executes the same built-worker scenario in the Docker-isolated Claude E2E service.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
