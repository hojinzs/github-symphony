...
- [#945](https://github.com/hojinzs/github-symphony/pull/945) [`71479b1`](https://github.com/hojinzs/github-symphony/commit/71479b17975a6bb56a78c2519dc30643aa1a8516) Thanks [@moncher-dev](https://github.com/moncher-dev)! - Keep generated Land conflict recovery guidance portable across repository package managers and document every Land lifecycle outcome ([#939](https://github.com/hojinzs/github-symphony/issues/939)).
...
- [#936](https://github.com/hojinzs/github-symphony/pull/936) [`a737db1`](https://github.com/hojinzs/github-symphony/commit/a737db16bbdcade954afeaa41b66e92e8c914feb) Thanks [@moncher-dev](https://github.com/moncher-dev)! - Validate project-root and absolute workflow hook scripts before dispatch when hook execution is trusted, surface workspace-relative hooks as deferred until reconciliation, and report invalid hook paths in the default doctor diagnostics for [#929](https://github.com/hojinzs/github-symphony/issues/929). Disabled hooks remain non-blocking, while doctor still diagnoses their paths. Bare command names are script paths relative to the hook's execution directory, so missing bare-name scripts now fail validation instead of being treated as inline commands.

- [#957](https://github.com/hojinzs/github-symphony/pull/957) [`1ddc6b4`](https://github.com/hojinzs/github-symphony/commit/1ddc6b40f108fd0b5cbd9d4c459d8fe880cedb55) Thanks [@moncher-dev](https://github.com/moncher-dev)! - Validate workflow hook path syntax and locally resolvable hook scripts in `workflow validate` ([#948](https://github.com/hojinzs/github-symphony/issues/948)).
...
- [#958](https://github.com/hojinzs/github-symphony/pull/958) [`ce4c21a`](https://github.com/hojinzs/github-symphony/commit/ce4c21a3ecd8d0c8a9bde54f48326b56ea59ad0e) Thanks [@moncher-dev](https://github.com/moncher-dev)! - Keep generated Land approval checks bound to the current pull request head ([#954](https://github.com/hojinzs/github-symphony/issues/954)).

- [#955](https://github.com/hojinzs/github-symphony/pull/955) [`71cd2a4`](https://github.com/hojinzs/github-symphony/commit/71cd2a4513d7248e54461b447730053accb27fec) Thanks [@moncher-dev](https://github.com/moncher-dev)! - Report stale standalone project workflow copies in status and doctor while treating repositories with no committed `WORKFLOW.md` as an intentional non-warning policy layout ([#952](https://github.com/hojinzs/github-symphony/issues/952)).
...
- [#949](https://github.com/hojinzs/github-symphony/pull/949) [`4917816`](https://github.com/hojinzs/github-symphony/commit/4917816f2bebf9a4fdcb88fa929550a976563a5e) Thanks [@moncher-dev](https://github.com/moncher-dev)! - Preserve legacy `codex` timeout declarations when a runtime block omits all or part of `runtime.timeouts`, and report each effective timeout's source through the `runtimeTimeoutSources` validation summary ([#888](https://github.com/hojinzs/github-symphony/issues/888)).
