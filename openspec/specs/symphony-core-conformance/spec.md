# symphony-core-conformance Specification

## Purpose

Define the core Symphony specification conformance requirements for workflow contract handling, persistent workspaces, prompt rendering, session lifecycle, and orchestration observability.
