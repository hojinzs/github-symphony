# github-project-tracker-adapter Specification

## Purpose

Define the optional GitHub Projects tracker adapter that binds workspaces to GitHub Projects and supports operator-assisted GitHub issue creation through the core tracker contract.
