# agent-service-credentials Specification

## Purpose
Define how the control plane registers, protects, brokers, rotates, and recovers operator-managed agent runtime credentials.
