# approval-gated-agent-workflow Specification

## Purpose

Define the multi-phase workflow where Symphony plans first, waits for human approval, implements after approval, and finishes tracked work when the linked pull request is merged.
